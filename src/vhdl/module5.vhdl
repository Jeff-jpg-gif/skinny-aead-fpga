...
k2 <= g or f;
k1 <= (not e and not f and not g and not h) or (e and not f and not g and h);
k0 <= (not e and g and h) or (not e and f and not g and not h) or (e and
not f and not g and not h) or (e and f and g);
end process;
end Behavioral;